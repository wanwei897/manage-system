<template>
  <div>
    <el-row :gutter="20">
      <el-col :span="8">
        <el-card shadow="hover" style="height: 252px; margin-bottom: 20px;">
          <div class="user-info">
        ...
        <el-card shadow="hover" style="height: 252px">
          <template #header>
            <div class="clearfix">语言详情</div>
          </template>
          <div>
            Vue
            <el-progress :percentage="69.4" color="#42b983"></el-progress>
            TypeScript
            <el-progress :percentage="13" color="#f1e05a"></el-progress>
            CSS
    ...
    <el-row :gutter="20">
			<el-col :span="12">
				<el-card shadow="hover" style="height: 342px;">
					<div class="chart-title">最近一周各品类销售图</div>
				</el-card>
			</el-col>
			<el-col :span="12">
				<el-card shadow="hover" style="height: 342px;">
					<div class="chart-title">最近几个月各品类销售趋势图</div>
				</el-card>
			</el-col>
		</el-row>
  </div>
